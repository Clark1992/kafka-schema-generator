...
namespace KafkaSchemaEvolutioner.Tests.Proto;

[ProtoContract]
public class SampleEventKey
{
    [ProtoMember(2)] public Guid NewSampleId { get; set; }
}
...
public class SampleRebuiltEvent
{
    ...
    [ProtoMember(9)] public DateTime NewOccurredAt { get; set; }
}
...
public class SampleAddress
{
    ...
    [ProtoMember(6)] public string NewCountry { get; set; }
}
...
public class SampleAttachment
{
    ...
    [ProtoMember(5)] public string NewUrl { get; set; }
}